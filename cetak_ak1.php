                    ...
                    <table id="datatable" class="table table-striped table-bordered table-condensed">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $tm['tempat_lahir'].', '.$tm['tanggal_lahir'] ?></td>
                          <td><?php echo $tm['jenis_kelamin'] ?></td>
                          <td><?php echo $tm['agama'] ?></td>
                          <td><?php echo $tm['no_hp'] ?></td>
                          <td><?php echo $tm['email'] ?></td>
                          <td width="5%">
                            <a href="cetak_ak1_pc?ref=<?php echo $tm['id_pencaker'] ?>" target="_blank" class="btn btn-success btn-xs"><i class="fa fa-print"></i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
