...
$pdf->Cell(120);
$pdf->Cell(120,5,'LAPORAN INFO LOWONGAN KERJA',0,1,'C');
$pdf->Ln(4);
...
$pdf->Cell(35,6,'TGL MULAI',1,0,'C',0);
$pdf->Cell(35,6,'TGL SELESAI',1,0,'C',0);
$pdf->Cell(75,6,'PERUSAHAAN',1,0,'C',0);
$pdf->Cell(45,6,'PIC',1,0,'C',0);
$pdf->Cell(32,6,'KONTAK',1,0,'C',0);
...
while($hasil=mysqli_fetch_array($sql)){
  ...
  $pdf->Cell(35,($line * $Height),tgl_indo($hasil['tgl_mulai']),1,0,'C',0);
  $pdf->Cell(35,($line * $Height),tgl_indo($hasil['tgl_selesai']),1,0,'C',0);
  $pdf->Cell(75,($line * $Height),$hasil['perusahaan'],1,0,'L',0);
  $pdf->Cell(45,($line * $Height),$hasil['pic'],1,0,'L',0);
  $pdf->Cell(32,($line * $Height),$hasil['kontak'],1,0,'L',0);
