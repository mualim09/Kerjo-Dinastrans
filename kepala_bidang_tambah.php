            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form method="post" action="kepala_bidang_act.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" name="jbtn">
                        </div>
                      </div>
